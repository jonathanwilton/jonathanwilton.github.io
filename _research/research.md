...
* Yayong Li, Zhengyi Du, Hong Zhang, Jonathan Wilton, Jinran Wu, Zongli Liu, Nan Ye. [Hierarchical Cluster-based Open-World Graph Active Learning](https://dl.acm.org/doi/abs/10.1145/3805712.3809744). Proceedings of the 49th International ACM SIGIR Conference on Research and Development in Information Retrieval, 2026.
* Jonathan Wilton, Nan Ye. [Robust Loss Functions for Training Decision Trees with Noisy Labels](https://ojs.aaai.org/index.php/AAAI/article/view/29516). Proceedings of the AAAI Conference on Artificial Intelligence, 38, 2024.
* Jonathan Wilton, Abigail M. Y. Koay, Ryan K. L. Ko, Miao Xu, Nan Ye. [Positive-unlabeled learning using random forests via recursive greedy risk minimization](https://proceedings.neurips.cc/paper_files/paper/2022/hash/98257285340854262185500e59bc0f28-Abstract-Conference.html). Advances in Neural Information Processing Systems, 36, 2022.
